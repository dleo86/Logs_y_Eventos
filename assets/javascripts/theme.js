								...
								'<div class="panel-body">',
									'<form>',
										'<div class="current-user text-center">',
											...
											'<h2 id="LockUserName" class="user-name text-danger m-none">{{username}}</h2>',
											
										'</div>',
										'<div class="form-group mb-lg">',
											'<div class="input-group input-group-icon">',
												'<input id="pwd" name="pwd" type="password" class="form-control input-lg" placeholder="Contraseña" />',
										...
										'<div class="row">',
											'<div class="col-xs-6">',
												'<p class="mt-xs mb-none">',
													'<a href="cerrar.php">Otro Usuario.</a>',
												'</p>',
											'</div>',
